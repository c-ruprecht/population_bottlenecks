getFP <- function(ReadsTableName, CFUtable, WhereAreReferences, minweight, outputfilename) {
  ...
  ResiliencyIndices <- function(samplename, plots = FALSE, ResiliencyLimit = 20000, FractionSD = 20){
   ...
   # } else  {times <- min(ceiling(cfu), sum(outvec > 1))}
    ...
    print(paste("[DEBUG] MCMC guesses:", paste(guessesuniquesorted, collapse=",")))
    guessesuniquesorted <- c(guessesuniquesorted, length(na.omit(x)))
    print(paste("[DEBUG] After adding max:", paste(guessesuniquesorted, collapse=",")))
    ...
    print(paste("[DEBUG] After read_diff check:", paste(guessesuniquesorted, collapse=",")))
    ...
    print(paste("[DEBUG] greatestdif:", greatestdif, "greatestdifx:", greatestdifx))
    ...
    print(paste("[DEBUG] After adding greatestdif/x:", paste(guessesuniquesorted, collapse=",")))
